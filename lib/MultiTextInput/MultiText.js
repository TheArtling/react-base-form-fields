...
MultiText.propTypes = {
  ...
  unique: _propTypes2.default.bool,
  renderTag: _propTypes2.default.func,
  onChange: _propTypes2.default.func,
  placeholder: _propTypes2.default.string,
  valueInitial: _propTypes2.default.any,
  input: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
  action: _propTypes2.default.oneOf(["add", "remove", "none"]),
