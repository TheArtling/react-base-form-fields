...
var MultiText = exports.MultiText = (0, _reactGetFormData.Formfield)(_class = function (_React$Component) {
  ...
  function MultiText(props) {
    ...
    _this.handleChange(props, value, false);
    return _this;
  }
  ...
  MultiText.prototype.handleRemoveTag = function handleRemoveTag(removalIndex) {
    ...
    if (Math.sign(removalIndex) === -1) indexToRemove += tagLength;
  ...
  MultiText.prototype.render = function render() {
    ...
    var WrapperComp = this.props.WrapperComp;
    var tags = this.state.tags;

    var renderedTags = tags.map(function (tag, index) {
      return _this2.renderTag(tag, index);
    });
    if (renderedTags.length > 0) return _react2.default.createElement(
      WrapperComp,
      null,
      renderedTags
    );
