...
exports.RNBaseTextInput = undefined;
...
var RNBaseTextInput = exports.RNBaseTextInput = (0, _reactGetFormData.Formfield)(_class = function (_React$Component) {
  _inherits(RNBaseTextInput, _React$Component);

  function RNBaseTextInput(props) {
    _classCallCheck(this, RNBaseTextInput);
  ...
  RNBaseTextInput.prototype.componentDidMount = function componentDidMount() {
  ...
  RNBaseTextInput.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
  ...
  RNBaseTextInput.prototype.getValue = function getValue(type, value) {
  ...
  RNBaseTextInput.prototype.getDisplayValue = function getDisplayValue(value) {
  ...
  RNBaseTextInput.prototype.handleChange = function handleChange(value) {
  ...
  RNBaseTextInput.prototype.render = function render() {
    var _this2 = this;
  ...
  return RNBaseTextInput;
}(_react2.default.Component)) || _class;

RNBaseTextInput.propTypes = {
